...
# You can comma separate for multiple folders : watched_paths = ["/volume1/dir1", "/volume1/second"]
    ...
    def is_allowed_path(self, filename, is_dir):
        ...
        if not is_dir:
            ...
            if ext not in allowed_exts:
                return False
        # Don't index @eaDir folders, which contain thumbnails generated by the indexer
        if filename.find("@eaDir") > 0:
            return False
        # Don't index .sync folders, which contain BTSync's settings and file versioning
